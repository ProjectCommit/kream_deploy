...
$(function () {
  $(".orderCheckListForm").on("click", function () {
...
<div class="right--zeroColumn">
	...
	<span id="adminPageSpan" class="specifyTitle" > 발주 관리</span>
 </div>
<div class="right--firstColumn">
	<div class="title"><span class="flex">발주 관리</span></div>
</div>
	        `;
...
<table cellspacing="0">
  ...
  showLoadingOverlay();
    		...
    		$.ajax({
			url : '/kream/admin/adminOrderCheckListForm_ajax',
			type:'post',
			dataType: 'json',
	        ...
	        $('.tableInfo').html(numOfProduct);
				...
				$.each(data, function(index, item){
					...
					result = `<tr>
					<td align="center"><input id="orderShippingBtn" type="button" value="배송 시작" class="orderShippingBtn"/><br></td>
    				<td align="center"><input id="shippingCancleBtn" type="button" value="발주 취소" class="orderCancleBtn"/></td>
