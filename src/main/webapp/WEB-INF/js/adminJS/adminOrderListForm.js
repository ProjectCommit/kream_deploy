$(function () {
  $(".orderListForm").on("click", function () {
...
<div class="right--zeroColumn">
	...
	<span id="adminPageSpan" class="specifyTitle" > 주문 확인</span>
 </div>
<div class="right--firstColumn">
	<div class="title"><span class="flex">주문 확인</span></div>
</div>
	        `;
...
<table cellspacing="0">
  ...
  showLoadingOverlay();
    		...
    		$.ajax({
			url : '/kream/admin/adminOrderListForm_ajax',
			type:'post',
			dataType: 'json',
	        ...
	        $('.tableInfo').html(numOfProduct);
				...
				$.each(data, function(index, item){
					...
					result = `<tr>
					<td align="center"><input id="orderCheckBtn" type="button" value="발주 확인" class="orderCheckBtn"/><br></td>
    				<td align="center"><input id="orderCancleBtn" type="button" value="발주 취소" class="orderCancleBtn"/></td>
